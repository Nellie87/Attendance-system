...
function getOpenCollectiveSponsors(): string
{
    ...
    $employees = json_decode(file_get_contents('https://opencollective.com/carbon/employees/all.json'), true);

    $list = array_filter($employees, static function ($member): bool {
